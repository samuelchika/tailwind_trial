      ...
      <div className='max-w-[1240px] mx-auto grid grid-cols-2 md:grid-cols-6 border-b-2 border-gray-600 py-8'>
        ...
        <div className="col-span-2 md:pt-2">
          ...
          <form className='flex flex-col sm:flex-row'>
            <input className='w-full p-2 mr-4 rounded-md mb-4' type="email" name="" id="" />
            <button className='p-2 mb-4'>Subscribe</button>
          </form>
        </div>
      </div>
      <div className='flex flex-col max-w-[1240px] m-auto justify-between sm:flex-row  text-center text-gray-500'>
        <p className='py-4'>&copy; 2022 Workflow, LLC. All rights reserved</p>
        <div className='flex justify-between sm:w-[300px] pt-4 text-2xl gap-3 px-4'>
          <FaFacebook />
          <FaInstagram />
          <FaTwitter />
          <FaTwitch />
